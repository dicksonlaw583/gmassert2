///@func test_case_no_trigger(assertion, [msg])
///@arg assertion The assertion call expression
///@arg {String} [msg] The message to display on failure
///@desc Check that the assertion is NOT triggered.
function test_case_no_trigger(assertion, msg="Test case "+string(global.__gma_case_count__+1)+" failed!") {
