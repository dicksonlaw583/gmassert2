function __gma_test_trigger_messages__() {
	...
	test_case_no_trigger(assert_equalish([1, 2, 3], [1, 2, 3]));
	test_case_no_trigger(assert_equalish(arrayA, [1, 2, 3]));
	...
	test_case_trigger(assert_in_range([pi, "Bob"], [4, "Caitlyn"], [5, "David"]));
	test_case_trigger(assert_in_range([pi, "Bob"], [2, "Alice"], [3, "Annie"]));
	test_case_trigger(assert_in_range([pi, "Bob"], [2, "Alice"], [3, "Caitlyn"]));
	test_case_trigger(assert_in_range([pi, "Bob"], [3, "Alice"], [4, "Annie"]));
	test_case_no_trigger(assert_in_range([pi, "Bob"], [3, "Alice"], [4, "Caitlyn"]));
	test_case_no_trigger(assert_in_range([pi, "Bob"], [3, "Bob"], [4, "Caitlyn"]));
	test_case_no_trigger(assert_in_range([pi, "Bob"], [pi, "Bob"], [4, "Caitlyn"]));
	test_case_no_trigger(assert_in_range([pi, "Bob"], [pi, "Alice"], [4, "Bob"]));
	...
	test_case_no_trigger(assert_not_in_range([pi, "Bob"], [4, "Caitlyn"], [5, "David"]));
	test_case_no_trigger(assert_not_in_range([pi, "Bob"], [2, "Alice"], [3, "Annie"]));
	test_case_no_trigger(assert_not_in_range([pi, "Bob"], [2, "Alice"], [3, "Caitlyn"]));
	test_case_no_trigger(assert_not_in_range([pi, "Bob"], [3, "Alice"], [4, "Annie"]));
	test_case_trigger(assert_not_in_range([pi, "Bob"], [3, "Alice"], [4, "Caitlyn"]));
	test_case_trigger(assert_not_in_range([pi, "Bob"], [3, "Bob"], [4, "Caitlyn"]));
	test_case_trigger(assert_not_in_range([pi, "Bob"], [pi, "Bob"], [4, "Caitlyn"]));
	test_case_trigger(assert_not_in_range([pi, "Bob"], [pi, "Alice"], [4, "Bob"]));
